  ...
  render() {
    return (
      <div className="ppp--about">
        ...
        <p>Yup. You read that correctly. Ever see a pet walking down the street and think, <em>I want to pet that pet </em>? Well now you can. Join Professional Pet Petters and create a team to see who can pet the most pets.</p>
