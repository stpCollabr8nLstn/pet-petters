    ...
    return (
      <div className="ppp--login">
        <div className="ppp--about">
          ...
          <p>Yup. You read that correctly. Ever see a pet walking down the street and think, "I want to pet that pet". Well now you can. Join our league and compete against players worldwide to see who can pet the most pets.</p>
